...
using ChatAppMVC.ViewModel.Auth;
...
namespace ChatAppMVC.Controllers
{
    public class AuthController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel customerRegisterVM)
        {
            if (ModelState.IsValid)
            {
                ...
                else if (answer[0] == "UsernameExists")
                {
        ...
        public async Task<IActionResult> Login(LoginViewModel loginVM)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result == ResultEnum.Done)
                {
                    ...
                    {
                        return RedirectToAction("LoadChats", "Chat");
                    }
                }
            }
